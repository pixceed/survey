"""
＜セルフリフレクション＞
タスクの実行結果をエージェント自身で振り返ること（＝リフレクション）
によって、その実行内容を自己改善させるパターン
"""
...
from src._05_design_pattern._02_prompt_optimizer import OptimizedGoal, PromptOptimizer
from src._05_design_pattern._03_response_optimizer import ResponseOptimizer
...
class ReflectionManager:
    def __init__(self, file_path: str = "src/_05_design_pattern/tmp/self_reflection_db.json"):
...
def main():
    ...
    reflection_manager = ReflectionManager(file_path="src/_05_design_pattern/tmp/self_reflection_db.json")
